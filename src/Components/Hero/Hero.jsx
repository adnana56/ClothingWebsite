...
const Hero = () => {
  return (
    <div className='h-screen flex flex-col md:flex-row bg-gradient-to-b from-[#ffb49c] to-[#e1ffea22] p-4 md:px-20'>
      {/* Left Section */}
      <div className='flex-1 flex flex-col justify-center gap-10 pl-4 md:pl-0 leading-tight pt-10 md:pt-0'>
        ...
        <div className="flex flex-col gap-2 md:gap-0">
          ...
          <p className='text-[#171717] text-4xl md:text-[5rem] py-10 font-bold'>collections</p>
          <p className='text-[#171717] text-4xl md:text-[5rem] font-bold'>for everyone</p>
        </div>

        <button className='w-48 md:w-72 h-12 md:h-16 rounded-full bg-[#ff4141] text-white text-base md:text-xl font-medium mt-6 flex justify-center items-center gap-4 cursor-pointer active:bg-red-600 hover:scale-110 transition-transform shadow-lg'>
          Latest Collection
      ...
      <div className='flex-1 flex items-center justify-center pt-10 md:pt-0'>
        <img src={hero_image} alt="Hero" className="w-[80%] md:w-[500px] object-contain drop-shadow-xl " />
      </div>
    </div>
  );
};
